<div class="navbar-menu interna">
    <a href="<?php echo get_site_url() ?>/home" class="w-inline-block">
    ...
    <ul class="ul-navmenu interna w-clearfix w-list-unstyled">
        ...
        <li class="li-navmenu">
            <a href="#" class="link-navmenu" data-ix="abrir-modal-equipe">Equipe</a>
        </li>

    </ul>
    <a href="javascript:history.go(-1)" class="w-inline-block">
