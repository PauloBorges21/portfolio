<div id="apresentacao-influen" class="section-sliders">
    <h2 class="h2-interna">Apresentação Influenciadores</h2>
    <div data-animation="slide" data-duration="500" data-infinite="1" class="sllider-interna w-slider">
        <div class="mask-sllider-interna w-slider-mask">
            ...
            <?php if (have_rows('apresentaCards', 106)) { //Se existir banner

                while (have_rows('apresentaCards', 106)) {
                    the_row(); //Percorre Todos os banners

                    $getCliente = get_sub_field('nome_do_cliente');
                    $getLogo = get_sub_field('logo', 106);
                    $getCliente = preg_replace('/[ -]+/', '-', $getCliente);
                    $exibe = get_sub_field('apresentacao_influenciadores');
