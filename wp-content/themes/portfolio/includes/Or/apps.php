<div id="apps" class="section-sliders">
    <h2 class="h2-interna">Apps</h2>
...
//inicio do loop de posts
                        ...
                        foreach ($my_posts as $post) : setup_postdata($post);
                            ...
                            <div class="item-sllider-interna w-slide"
                                 ...
                                 onclick="SliderModalPrincipal(this)"  data-menu="modal-apps">
...
<div class="modal-conteudo-interna" id="modal-apps">
    <div class="box-content-modal">
        <div class="container-video-modal">
            ...
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/btn-fechar.png" alt=""
                 class="btn-fechar-modal-conteudo" onclick="fechaME(this)" data-rai="modal-apps">
        </div>
