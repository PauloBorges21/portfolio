<div id="private" class="section-sliders">
    <h2 class="h2-interna">PRIVATE LABEL</h2>
        ...
        <div class="mask-sllider-interna w-slider-mask">
            ...
            <?php if (have_rows('apresentaCards', 116)) { //Se existir banner
                ...
                while (have_rows('apresentaCards', 116)) {
                    ...
                    $exibe = get_sub_field('private_label');
...
//inicio do loop de posts
                        ...
                        foreach ($my_posts as $post) : setup_postdata($post);
                            ...
                            <div class="item-sllider-interna w-slide"
                                 ...
                                 onclick="SliderModalPrincipal(this)"  data-menu="modal-private">
...
<div class="modal-conteudo-interna" id="modal-private">
    <div class="box-content-modal">
        <div class="container-video-modal">
            ...
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/btn-fechar.png" alt=""
                 class="btn-fechar-modal-conteudo" onclick="fechaME(this)" data-rai="modal-private">
        </div>
