                ...
                foreach ($my_posts as $post) : setup_postdata($post);
                    ...
                    <div class="item-sllider-interna w-slide"
                        ...
                        <div class="content-slide" style="padding-top:60px;">
                            <img src="<?php echo $getLogo ?>" alt="" class="" style="width: 100%; display: inline-block;">
                                ...
                                foreach ($my_posts as $post) : setup_postdata($post);
                                    ...
                                    <li class="li-veja-tambem">
                                        ...
                                        <div class="box-img-vejatambem"
                                            ...
                                            <img src="<?php echo the_field('thumb_veja_mais'); ?>" alt="" class="img-prev-veja-tambem"
