            ...
            if (have_rows('apresentaCards', $url)) { //Se existir banner
                ...
                while (have_rows('apresentaCards', $url)) {
                    ...
                    foreach ($my_posts as $post) : setup_postdata($post);
                        ...
                        ?>
                        <li class="li-pg-clientes" data-slidermd="<?php echo $getCliente ?>-<?php echo $post->ID ?>"
                            onclick="SliderModalPrincipal(this)" data-menu="modal-midiaEletronica">
                            <img src="<?php echo $getLogo ?>" alt="" class="" style="max-width: 100%;
...
<?php
            ...
            ?>
                <form action="/" data-form="SliderVejaMais-<?php echo $post->ID ?>-<?php echo $getCliente?> ">
                ...
                <form action="/" data-formCont="<?php echo $getCliente ?>">
                    <input hidden="" name="nomeCliente" value="<?php echo $getCliente?>-<?php echo $post->ID ?>">
                    <input hidden="" name="imagemThumb" value="<?php echo the_field('thumb_veja_mais'); ?>">
            <?php endforeach;?>
                </form>
            </li>
                    <div class="box-img-vejatambem"  onclick="sliderModalVejaMais(this)" data-ix="">
                        <img src="<?php echo the_field('thumb_veja_mais'); ?>" alt=""
                             class="img-prev-veja-tambem"
                             data-sliderModalVeja="SliderVejaMais-<?php echo $post->ID ?>">
                    </div>
